...
sigma = st.sidebar.slider("Infectious period rate (sigma)", 0.0, 0.1, 0.03)
...
pie = st.sidebar.slider("Birth rate (pie)", 0.0, 0.1, 0.02)
...
# Initial conditions
sol0 = np.array([N*0.95, N*0.03, 0.02*N, 0, 0])
...
fig.add_trace(go.Scatter(x=T, y=sol1[4], mode='lines', name='Vaccinated', line=dict(dash='dash', color='magenta')))
